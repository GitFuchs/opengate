...
{
  // std::cout << "AttachImageToVolume" << std::endl;
  ...
  // std::cout << "Image dimensions: " << getDimensions << std::endl;
  if (getDimensions == 4)
  {
    ...
    // set direction of 4th dimension
    dir[3][3] = 1;
  ...
  // std::cout << "Image origin: " << o << std::endl;
  // std::cout << "Image direction: " << dir << std::endl;
  image->SetOrigin(o);
