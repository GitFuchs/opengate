/* --------------------------------------------------
   ...
   Hermann Fuchs, Medical University of Vienna, April 2025
   ------------------------------------ -------------- */
...
void GateAMDMActor::BeginOfRunActionMasterThread(int run_id)
{
  std::cout << "AMDM actor starting run BeginOfRunActionMasterThread"
  << std::endl;
  std::cout << "fPhysicalVolumeName: " << fPhysicalVolumeName << std::endl;
  std::cout << "fInitialTranslation: " << fInitialTranslation << std::endl;  
...
// run at the end of the run for the master thread
// void GateAMDMActor::EndOfRunActionMasterThread(const G4Run * /*unused*/)
int GateAMDMActor::EndOfRunActionMasterThread(int run_id)
{
